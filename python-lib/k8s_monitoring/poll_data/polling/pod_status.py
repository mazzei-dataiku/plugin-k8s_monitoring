...
def get_data(self, dt):
    ...
    for i in ret.items:
        ...
        if labels:
            ...
            dss_install_id    = labels.get('dataiku.com/dku-install-id',                None)
            ...
            pod_webapp_id     = labels.get('dataiku.com/dku-webapp-id',                 None)            
            pod_analysis_id   = labels.get('dataiku.com/dku-analysis-id',               None)
            pod_mltask_id     = labels.get('dataiku.com/dku-mltask-id',                 None)
            pod_ml_sess_id    = labels.get('dataiku.com/dku-mltask-session-id',         None)
            pod_apiD_infra_id = labels.get('dataiku.com/dku-apideployer-infra-id',      None)
            pod_apiD_serv_id  = labels.get('dataiku.com/dku-apideployer-service-id',    None)
            pod_apiD_depl_id  = labels.get('dataiku.com/dku-apideployer-deployment-id', None)
        ...
        t.append(pod_job_id)
        t.append(pod_webapp_id)
        t.append(pod_analysis_id)
        t.append(pod_mltask_id)
        t.append(pod_ml_sess_id)
